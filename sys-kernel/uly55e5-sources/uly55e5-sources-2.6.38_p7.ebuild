...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/pf-sources/pf-sources-2.6.38_p7.ebuild,v 1.1 2011/05/04 07:34:37 wired Exp $
...
DESCRIPTION="Linux kernel pf-fork with m-audio fast-track pro patch"
...
UNIPATCH_LIST="${UNIPATCH_LIST}
               ${FILESDIR}/fasttrackpro-${PV/_p[0-9]*}.patch"

pkg_setup(){
	ewarn
	ewarn "${PN} is *not* supported by the Gentoo Kernel Project in any way."
	ewarn "If you need support, please contact the pf and uly55e5 developers directly."
