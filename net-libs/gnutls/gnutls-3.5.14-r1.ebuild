...
IUSE="+cxx dane doc examples guile +idn nls openpgp +openssl pkcs11 sslv2 +sslv3 seccomp static-libs test test-full +tls-heartbeat tools valgrind zlib ${IUSE_LINGUAS// / linguas_} system-unistring"
...
RDEPEND=">=dev-libs/libtasn1-4.9:=[${MULTILIB_USEDEP}]
	system-unistring? ( dev-libs/libunistring:=[${MULTILIB_USEDEP}] )
...
multilib_src_configure() {
    ...
    if use system-unistring; then
		SYS_UNISTRING=""
	else
		SYS_UNISTRING="--with-included-unistring"
    fi
